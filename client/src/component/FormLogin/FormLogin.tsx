...
type PropsType = {
    onSubmit: (values: FormLoginType) => void
}

export const FormLogin: React.FC<PropsType> = React.memo((props) => {
    ...
    const formikConfig: FormikConfig<FormLoginType> = {
        initialValues: {
            email: '',
            password: ''
        },
    ...
    return (
        <form className={s.form} onSubmit={formik.handleSubmit}>
            <span className={s.form__title}>Вход</span>
